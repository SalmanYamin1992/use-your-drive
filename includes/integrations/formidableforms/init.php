...
class FormidableForms
{
    ...
    public $default_value = '[useyourdrive class="formidableforms_upload_box" mode="upload" upload="1" uploadrole="all" upload_auto_start="0" userfolders="auto" viewuserfoldersrole="none"]';
    ...
    public function field_options_form($field, $display, $values)
    {
        ...
        <tr>
            ...
            <a href="#" class='button-primary useyourdrive open-shortcode-builder'><?php esc_html_e('Build your shortcode', 'wpcloudplugins'); ?></a>
            </td>
        </tr>
        <?php
    }
    ...
    public function enqueue()
    {
        ...
        wp_enqueue_script('WPCP-'.$this->field_type.'-FormidableForms', plugins_url('FormidableForms.js', __FILE__), ['jquery'], USEYOURDRIVE_VERSION, true);
    }
