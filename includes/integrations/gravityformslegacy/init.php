...
class GFUseyourDriveAddOn extends GFAddOn
{
    ...
    public function gform_editor_js()
    {
        ...
        <script type='text/javascript'>
            (function ($) {
              ...
              $('.UseyourDrive-GF-shortcodegenerator').on('click',function (e) {
    ...
    public function useyourdrive_settings($position, $form_id)
    {
        if (1430 == $position) {
            ...
            <li class="useyourdrive_setting field_setting">
              ...
              <a href="#" class='button-primary UseyourDrive-GF-shortcodegenerator '><?php esc_html_e('Build your shortcode', 'wpcloudplugins'); ?></a>
    ...
    public function useyourdrive_title($title, $field_type)
    {
        if ('useyourdrive' === $field_type) {
            return 'Use-your-Drive'.esc_html__('Upload', 'wpcloudplugins');
        }
    ...
    {
        $tooltips['form_field_useyourdrive'] = '<h6>Use-your-Drive Shortcode</h6>'.esc_html__('Build your shortcode here', 'wpcloudplugins');
