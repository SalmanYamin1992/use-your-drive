    ...
    public function field_options($field)
    {
        ...
        $fld = $this->field_element(
            ...
            [
                ...
                'name' => 'shortcode',
                'rows' => 5,
                'value' => isset($field['shortcode']) ? $field['shortcode'] : '[useyourdrive class="wpforms_upload_box" mode="upload" upload="1" uploadrole="all" upload_auto_start="0" userfolders="auto" viewuserfoldersrole="none"]',
            ],
            false
        );
