...
{
    public $default_value = '[useyourdrive class="fluentforms_upload_box" mode="upload" upload="1" uploadrole="all" upload_auto_start="0" userfolders="auto" viewuserfoldersrole="none"]';
    ...
    public function enqueueEditorAssets()
    {
        ...
        wp_enqueue_script('WPCP-'.$this->field_type.'-FluentForms', plugins_url('FluentForms.js', __FILE__), ['jquery'], USEYOURDRIVE_VERSION, true);
    }
