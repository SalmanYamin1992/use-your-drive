...
class ContactForm
{
    ...
    public function __construct(\TheLion\UseyourDrive\Main $_main)
    {
    ...
    public function add_tag_generator()
    {
        if (class_exists('WPCF7_TagGenerator')) {
            ...
            $tag_generator->add('useyourdrive', 'Use-your-Drive', [$this, 'tag_generator_body']);
        }
    }
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <input type="button" class="button button-primary UseyourDrive-CF-shortcodegenerator " value="<?php echo esc_attr(esc_html__('Build your shortcode here', 'wpcloudplugins')); ?>" />
                    <iframe id="useyourdrive-shortcode-iframe" src="about:blank" data-src='<?php echo USEYOURDRIVE_ADMIN_URL; ?>?action=useyourdrive-getpopup&type=shortcodebuilder&asuploadbox=1&callback=wpcp_uyd_cf7_add_content' width='100%' height='500' tabindex='-1' frameborder='0' style="display:none"></iframe>
    ...
    public function shortcode_handler($tag)
    {
        ...
        if ($required) {
            add_filter('useyourdrive_shortcode_set_options', [$this, 'set_required_shortcode'], 10, 3);
        }
        // Shortcode
