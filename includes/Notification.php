...
class Notification
{
    ...
    public function send_notification()
    {
        ...
        do_action('useyourdrive_log_event', 'useyourdrive_sent_notification', $this->folder, ['notification_type' => $this->type, 'subject' => $subject, 'recipients' => $recipients]);
    ...
    private function _create_placeholders()
    {
        ...
        foreach ($this->entries as $cached_node) {
            ...
            $fileline = strtr($this->_update_depricated_placeholders($this->entry_list), [
                ...
                '%file_created%' => $entry->get_created_time_str(),
