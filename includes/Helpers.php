...
class Helpers
{
    ...
    public static function get_all_users_and_roles()
    {
        ...
        foreach ($users as $wp_user) {
            ...
            $list[] = [
                ...
                'img' => ($user_count < 1000) ? get_avatar_url($wp_user->id, ['size' => '32']) : USEYOURDRIVE_ROOTPATH.'/css/images/usericon.png',
            ];
            ++$i;
        }
    ...
    public static function get_default_thumbnail_icon($mimetype)
    {
        switch ($mimetype) {
            ...
            case 'application/vnd.google-apps.shortcut':
                $thumbnailicon = 'icon_11_script_xl128';

                break;

            default:
                $thumbnailicon = 'icon_11_generic_xl128.png';
    ...
    public static function encrypt($data)
    {
        ...
        $first_encrypted = openssl_encrypt($data, $method, USEYOURDRIVE_AUTH_KEY, OPENSSL_RAW_DATA, $iv);
    ...
    public static function decrypt($input)
    {
        ...
        return openssl_decrypt($first_encrypted, $method, USEYOURDRIVE_AUTH_KEY, OPENSSL_RAW_DATA, $iv);
    }
    ...
    public static function get_mimetype($extension = '')
    {
        ...
        $mime_types_map['shortcut'] = 'application/vnd.google-apps.shortcut';
