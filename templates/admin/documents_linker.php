      ...
      <div class="useyourdrive-header">
        ...
        <div class="useyourdrive-form-buttons">
          ...
          <div class="tippy-content-holder">
            <ul class='link-list'>
              <li class="link-item">
                <a class="link-preview" data-type="preview" title="<?php esc_html_e('Link to preview', 'wpcloudplugins'); ?>">
                  <i class='fas fa-eye'></i> <?php esc_html_e('Link to preview', 'wpcloudplugins'); ?>
                </a>
              </li>
              <li class="link-item">
                <a class="link-download" data-type="download" title="<?php esc_html_e('Link to download', 'wpcloudplugins'); ?>">
                  <i class='fas fa-arrow-down'></i> <?php esc_html_e('Link to download', 'wpcloudplugins'); ?>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div class="useyourdrive-title"><?php esc_html_e('Insert Direct links', 'wpcloudplugins'); ?></div>
