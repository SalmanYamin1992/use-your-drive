...
function UseyourDrive_remove_all_scripts()
{
    ...
    $vars = [
        'whitelist' => json_encode(\TheLion\UseyourDrive\Helpers::get_all_users_and_roles()),
        'ajax_url' => USEYOURDRIVE_ADMIN_URL,
    ];

    wp_localize_script('UseyourDrive.ShortcodeBuilder', 'UseyourDrive_ShortcodeBuilder_vars', $vars);
  ...
  <form action="#" data-callback="<?php echo isset($_REQUEST['callback']) ? $_REQUEST['callback'] : ''; ?>">
    ...
    <div class="wrap">
      <div class="useyourdrive-header">
        ...
        <div class="useyourdrive-title"><?php esc_html_e('Shortcode Builder', 'wpcloudplugins'); ?></div>

      </div>
      <div id="" class="useyourdrive-panel useyourdrive-panel-left">
        <div class="useyourdrive-nav-header"><?php esc_html_e('Module Configuration', 'wpcloudplugins'); ?></div>
      ...
      <div class="useyourdrive-panel useyourdrive-panel-right">
        ...
        <div id="settings_general" class="useyourdrive-tab-panel current">
          ...
          <div class="useyourdrive-option-title"><?php esc_html_e('Module', 'wpcloudplugins'); ?></div>
          <div class="useyourdrive-option-description"><?php esc_html_e('Select how you want to display your content', 'wpcloudplugins'); ?>:</div>
          <div class="useyourdrive-option-radio">
            ...
            <label for="files" class="useyourdrive-option-radio-label"><?php esc_html_e('File Browser', 'wpcloudplugins'); ?></label>
          </div>
          <div class="useyourdrive-option-radio">
            <input type="radio" id="upload" name="mode" <?php echo ('upload' === $mode) ? 'checked="checked"' : ''; ?> value="upload" class="mode" />
            <label for="upload" class="useyourdrive-option-radio-label"><?php esc_html_e('Upload Box', 'wpcloudplugins'); ?></label>
          </div>
          <?php if (false === $uploadbox_only) { ?>
            <div class="useyourdrive-option-radio">
              ...
              <label for="gallery" class="useyourdrive-option-radio-label"><?php esc_html_e('Photo Gallery', 'wpcloudplugins'); ?> <small>(Images only)</small></label>
            </div>
            <div class="useyourdrive-option-radio">
              <input type="radio" id="audio" name="mode" <?php echo ('audio' === $mode) ? 'checked="checked"' : ''; ?> value="audio" class="mode" />
              <label for="audio" class="useyourdrive-option-radio-label"><?php esc_html_e('Audio Player', 'wpcloudplugins'); ?> <small>(MP3, M4A, OGG, OGA, WAV)</small></label>
            </div>
            <div class="useyourdrive-option-radio">
              <input type="radio" id="video" name="mode" <?php echo ('video' === $mode) ? 'checked="checked"' : ''; ?> value="video" class="mode" />
              <label for="video" class="useyourdrive-option-radio-label"><?php esc_html_e('Video Player', 'wpcloudplugins'); ?> <small>(MP4, M4V, OGG, OGV, WEBM, WEBMV)</small></label>
            </div>
            <div class="useyourdrive-option-radio">
              <input type="radio" id="search" name="mode" <?php echo ('search' === $mode) ? 'checked="checked"' : ''; ?> value="search" class="mode" />
              <label for="search" class="useyourdrive-option-radio-label"><?php esc_html_e('Search Box', 'wpcloudplugins'); ?></label>
            </div>
          <?php
          } else {
              ?>
        ...
        <div id="settings_folders" class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-tab-panel-header"><?php esc_html_e('Folders', 'wpcloudplugins'); ?></div>

          <div class="forfilebrowser forgallery">
            <div class="useyourdrive-option-title"><?php esc_html_e('Use single cloud account', 'wpcloudplugins'); ?>
            ...
            <div class="useyourdrive-option-description"><?php esc_html_e('Use a folder from one of the linked account. Disabling this option allows your users to navigate through the folders of all your linked accounts', 'wpcloudplugins'); ?>
            </div>
          </div>

          <div class="option-singleaccount <?php echo (isset($_REQUEST['singleaccount']) && '0' === $_REQUEST['singleaccount']) ? 'hidden' : ''; ?>">
            <div class="useyourdrive-option-title"><?php esc_html_e('Select start Folder', 'wpcloudplugins'); ?></div>
            <div class="useyourdrive-option-description"><?php esc_html_e('Select which folder should be used as starting point, or in case the Smart Client Area is enabled should be used for the Private Folders', 'wpcloudplugins'); ?>. <?php esc_html_e('Users will not be able to navigate outside this folder', 'wpcloudplugins'); ?>.</div>
            ...
            <br />
            <div class="useyourdrive-tab-panel-header"><?php esc_html_e('Smart Client Area', 'wpcloudplugins'); ?></div>

            <div class="useyourdrive-option-title"><?php esc_html_e('Use Private Folders', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-option-description">
              <?php echo sprintf(esc_html__('The plugin can easily and securily share documents on your %s with your users/clients', 'wpcloudplugins'), 'Google Drive'); ?>.
            ...
            <div class="useyourdrive-suboptions option-userfolders forfilebrowser foruploadbox forgallery <?php echo (isset($_REQUEST['userfolders'])) ? '' : 'hidden'; ?>">
              ...
              <div class="useyourdrive-option-title"><?php esc_html_e('Mode', 'wpcloudplugins'); ?></div>
              <div class="useyourdrive-option-description"><?php esc_html_e('Do you want to link your users manually to their Private Folder or should the plugin handle this automatically for you?', 'wpcloudplugins'); ?>.</div>
              ...
              <div class="useyourdrive-option-radio">
                ...
                <label for="userfolders_method_manual" class="useyourdrive-option-radio-label"><?php echo '<strong>'.esc_html__('Manual').':</strong> '.sprintf(esc_html__('I will link the users manually via %sthis page%s', 'wpcloudplugins'), '<a href="'.admin_url('admin.php?page=UseyourDrive_settings_linkusers').'" target="_blank">', '</a>'); ?></label>
              </div>
              <div class="useyourdrive-option-radio">
                ...
                <label for="userfolders_method_auto" class="useyourdrive-option-radio-label"><?php echo '<strong>'.esc_html__('Auto').':</strong> '.esc_html__('Let the plugin automatically manage the Private Folders for me in the folder I have selected above', 'wpcloudplugins'); ?></label>
              </div>

              <div class="option-userfolders_auto">
                  <div class="useyourdrive-option-title"><?php esc_html_e('Name Template', 'wpcloudplugins'); ?></div>
                  <input type="text" name="UseyourDrive_userfolders_name_template" id="UseyourDrive_userfolders_name_template" class="useyourdrive-option-input-large" value="<?php echo (isset($_REQUEST['userfoldernametemplate'])) ? $_REQUEST['userfoldernametemplate'] : ''; ?>" autocomplete="off" placeholder="<?php echo $this->settings['userfolder_name']; ?>" data-global-value="<?php echo $this->settings['userfolder_name']; ?>"/>
                  <div class="useyourdrive-option-description">
              ...
              <div class="useyourdrive-option-title"><?php esc_html_e('Open Subfolder', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
                  <input type="checkbox" name="UseyourDrive_userfolders_use_subfolder" id="UseyourDrive_userfolders_use_subfolder" class="useyourdrive-onoffswitch-checkbox" <?php echo (isset($_REQUEST['subfolder'])) ? 'checked="checked"' : ''; ?> data-div-toggle='userfolders-subfolder-option'/>
                  <label class="useyourdrive-onoffswitch-label" for="UseyourDrive_userfolders_use_subfolder"></label>
                </div>
                <div class="useyourdrive-option-description">
                  <?php esc_html_e('Do you want to set a specific subfolder inside the Private Folder as start folder?', 'wpcloudplugins'); ?>
                </div>                      

                <div class="useyourdrive-suboptions userfolders-subfolder-option <?php echo (isset($_REQUEST['subfolder'])) ? '' : 'hidden'; ?>">
                  <input type="text" name="UseyourDrive_subfolder" id="UseyourDrive_subfolder" class="useyourdrive-option-input-large" value="<?php echo (isset($_REQUEST['subfolder'])) ? $_REQUEST['subfolder'] : ''; ?>" autocomplete="off" placeholder="e.g. /Documents"/>
                  <div class="useyourdrive-option-description">
              ...
              <div class="option-userfolders_auto">
                <div class="useyourdrive-option-title"><?php esc_html_e('Template Folder', 'wpcloudplugins'); ?>
                  <div class="useyourdrive-onoffswitch">
        ...
        <div id="settings_layout" class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-option-title"><?php esc_html_e('Module width', 'wpcloudplugins'); ?></div>
          <div class="useyourdrive-option-description"><?php esc_html_e('Set max width for the plugin container', 'wpcloudplugins'); ?>. <?php esc_html_e("You can use pixels or percentages, eg '360px', '480px', '70%'", 'wpcloudplugins'); ?>. <?php esc_html_e('Leave empty for default value.', 'wpcloudplugins'); ?></div>
          ...
          <div class="forfilebrowser forgallery forsearch foruploadbox">
            <div class="useyourdrive-option-title"><?php esc_html_e('Module height', 'wpcloudplugins'); ?></div>
            <div class="useyourdrive-option-description"><?php esc_html_e('Set max height for the plugin container', 'wpcloudplugins'); ?>. <?php esc_html_e("You can use pixels or percentages, eg '360px', '480px', '70%'", 'wpcloudplugins'); ?>. <?php esc_html_e('Leave empty for default value.', 'wpcloudplugins'); ?></div>
          ...
          <div class="useyourdrive-option-title"><?php esc_html_e('Custom CSS Class', 'wpcloudplugins'); ?></div>
          <div class="useyourdrive-option-description"><?php esc_html_e('Add your own custom classes to the plugin container. Multiple classes can be added seperated by a whitespace', 'wpcloudplugins'); ?>.</div>
          ...
          <div class="foraudio forvideo">
            ...
            <div class="useyourdrive-option-title"><?php esc_html_e('Media Player', 'wpcloudplugins'); ?></div>
            <div>
            ...
            <div class="useyourdrive-option-title"><?php esc_html_e('Mediaplayer Buttons', 'wpcloudplugins'); ?></div>
            <div class="useyourdrive-option-description"><?php esc_html_e('Set which buttons (if supported) should be visible in the mediaplayer', 'wpcloudplugins'); ?>.</div>
            ...
            foreach ($buttons as $button_value => $button) {
                ...
                echo '<div class="useyourdrive-option-checkbox useyourdrive-option-checkbox-vertical-list media-buttons" title="'.$button['title'].'">';
                echo '<input class="simple" type="checkbox" name="UseyourDrive_media_buttons[]" value="'.$button_value.'" '.$checked.'/>';
                echo '<label for="UseyourDrive_media_buttons" class="useyourdrive-option-checkbox-label">'.$button['icon'].'</label>';
                echo '</div>';
            } ?>

            <div class="useyourdrive-option-title"><?php esc_html_e('Show Playlist', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-suboptions playlist-options <?php echo (isset($_REQUEST['hideplaylist']) && '1' === $_REQUEST['hideplaylist']) ? 'hidden' : ''; ?>">
              <div class="useyourdrive-option-title"><?php esc_html_e('Playlist open on start', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
              ...
              <div class="forvideo">
                <div class="useyourdrive-option-title"><?php esc_html_e('Playlist opens on top of player', 'wpcloudplugins'); ?>
                  <div class="useyourdrive-onoffswitch">
              ...
              <div class="useyourdrive-option-title"><?php esc_html_e('Display thumbnails', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
              ...
              <div class="useyourdrive-option-description"><?php esc_html_e('Show thumbnails of your files in the Playlist', 'wpcloudplugins'); ?>. <?php esc_html_e('The plugin show the thumbnail provided by the cloud server or you can use your own one', 'wpcloudplugins'); ?>. <?php esc_html_e('If you want to use your own thumbnail, add a *.png or *.jpg file with the same name in the same folder. You can also add a cover with the name of the folder to show the cover for all files', 'wpcloudplugins'); ?>. <?php esc_html_e('If no cover is available, a placeholder will be used', 'wpcloudplugins'); ?>.</div>

              <div class="useyourdrive-option-title"><?php esc_html_e('Show last modified date', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
              ...
              <div class="useyourdrive-option-title"><?php esc_html_e('Download Button', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
              ...
              <div class="useyourdrive-option-title"><?php esc_html_e('Purchase Button', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
              ...
              <div class="option webshop-options <?php echo (isset($_REQUEST['linktoshop'])) ? '' : 'hidden'; ?>">
                <div class="useyourdrive-option-title"><?php esc_html_e('Link to webshop', 'wpcloudplugins'); ?></div>
          ...
          <div class="forfilebrowser forsearch">
            <div class="useyourdrive-option-title"><?php esc_html_e('File Browser view', 'wpcloudplugins'); ?></div>
            <?php
            ...
            <div class="useyourdrive-option-radio">
              ...
              <label for="file_layout_grid" class="useyourdrive-option-radio-label"><?php esc_html_e('Grid/Thumbnail View', 'wpcloudplugins'); ?></label>
            </div>
            <div class="useyourdrive-option-radio">
              <input type="radio" id="file_layout_list" name="UseyourDrive_file_layout" <?php echo ('list' === $filelayout) ? 'checked="checked"' : ''; ?> value="list" />
              <label for="file_layout_list" class="useyourdrive-option-radio-label"><?php esc_html_e('List View', 'wpcloudplugins'); ?></label>
            </div>
          </div>

          <div class=" forfilebrowser forgallery">
            <div class="useyourdrive-option-title"><?php esc_html_e('Show header', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-suboptions header-options <?php echo (isset($_REQUEST['showbreadcrumb']) && '0' === $_REQUEST['showbreadcrumb']) ? 'hidden' : ''; ?>">
              <div class="useyourdrive-option-title"><?php esc_html_e('Show refresh button', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
              ...
              <div class="useyourdrive-option-description"><?php esc_html_e('Add a refresh button in the header so users can refresh the file list and pull changes', 'wpcloudplugins'); ?></div>

              <div class="useyourdrive-option-title"><?php esc_html_e('Breadcrumb text for top folder', 'wpcloudplugins'); ?></div>
              <input type="text" name="UseyourDrive_roottext" id="UseyourDrive_roottext" placeholder="<?php esc_html_e('Start', 'wpcloudplugins'); ?>" value="<?php echo (isset($_REQUEST['roottext'])) ? $_REQUEST['roottext'] : ''; ?>" />
            </div>
          </div>
          <div class=" forfilebrowser forsearch forgallery">
            <div class="option forfilebrowser forsearch forlistonly">
              <div class="useyourdrive-suboptions">
                <div class="option-filesize">
                  <div class="useyourdrive-option-title"><?php esc_html_e('Show file size', 'wpcloudplugins'); ?>
                    <div class="useyourdrive-onoffswitch">
                  ...
                  <div class="useyourdrive-option-description"><?php esc_html_e('Display or Hide column with file sizes in List view', 'wpcloudplugins'); ?></div>
                </div>
                ...
                <div class="option-filedate">
                  ...
                  <div class="useyourdrive-option-description"><?php esc_html_e('Display or Hide column with last modified date in List view', 'wpcloudplugins'); ?></div>
                </div>
              </div>
            </div>

            <div class="option forfilebrowser forsearch">
              <div class="useyourdrive-option-title"><?php esc_html_e('Show file extension', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
              ...
              <div class="useyourdrive-option-description"><?php esc_html_e('Display or Hide the file extensions', 'wpcloudplugins'); ?></div>
            </div>

            <div class="option forfilebrowser forsearch forgallery">
              <div class="useyourdrive-option-title"><?php esc_html_e('Show files', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
              ...
              <div class="useyourdrive-option-description"><?php esc_html_e('Display or Hide files', 'wpcloudplugins'); ?></div>
            </div>

            <div class="useyourdrive-option-title"><?php esc_html_e('Show folders', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-option-description"><?php esc_html_e('Display or Hide child folders', 'wpcloudplugins'); ?></div>
          </div>

          <div class="option forfilebrowser forsearch forlistonly">
            <div class="option-hoverthumbs">
              <div class="useyourdrive-option-title"><?php esc_html_e('Show thumbnails on hover', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
                  <input type="checkbox" name="UseyourDrive_hoverthumbs" id="UseyourDrive_hoverthumbs" class="useyourdrive-onoffswitch-checkbox" <?php echo (isset($_REQUEST['hoverthumbs']) && '0' === $_REQUEST['hoverthumbs']) ? '' : 'checked="checked"'; ?> />
                  <label class="useyourdrive-onoffswitch-label" for="UseyourDrive_hoverthumbs"></label>
                </div>
              </div>
              <div class="useyourdrive-option-description"><?php esc_html_e('Display a thumbnail when hovering over an file in List view', 'wpcloudplugins'); ?></div>
            </div>
          </div>

          <div class="option forgallery">
            <div class="useyourdrive-option-title"><?php esc_html_e('Show file names', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-option-description"><?php esc_html_e('Display or Hide the file names in the gallery', 'wpcloudplugins'); ?></div>

            <div class="useyourdrive-option-title"><?php esc_html_e('Show descriptions on top', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-option-description"><?php esc_html_e('Display directly on top of the thumbnail', 'wpcloudplugins'); ?>. <?php esc_html_e('When disabled, the description can be shown by hovering over the image', 'wpcloudplugins'); ?>.</div>

            <div class="useyourdrive-option-title"><?php esc_html_e('Gallery row height', 'wpcloudplugins'); ?></div>
            <div class="useyourdrive-option-description"><?php esc_html_e('The ideal height you want your grid rows to be', 'wpcloudplugins'); ?>. <?php esc_html_e("It won't set it exactly to this as plugin adjusts the row height to get the correct width", 'wpcloudplugins'); ?>. <?php esc_html_e('Leave empty for default value.', 'wpcloudplugins'); ?> (300px).</div>
            ...
            <div class="useyourdrive-option-title"><?php esc_html_e('Number of images lazy loaded', 'wpcloudplugins'); ?></div>
            <div class="useyourdrive-option-description"><?php esc_html_e('Number of images to be loaded each time', 'wpcloudplugins'); ?>. <?php esc_html_e('Set to 0 to load all images at once', 'wpcloudplugins'); ?>.</div>
            ...
            <!---
                  <div class="useyourdrive-option-title"><?php esc_html_e('Show Folder Thumbnails in Gallery', 'wpcloudplugins'); ?>
                    <div class="useyourdrive-onoffswitch">
                  ...
                  <div class="useyourdrive-option-description"><?php esc_html_e('Do you want to show thumbnails for the Folders in the gallery mode?', 'wpcloudplugins'); ?> <?php esc_html_e('Please note, when enabled the loading performance can drop proportional to the number of folders present in the Gallery', 'wpcloudplugins'); ?>.</div>
                  -->

            <div class="useyourdrive-option-title"><?php esc_html_e('Slideshow', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="slideshow-options">
              <div class="useyourdrive-option-description"><?php esc_html_e('Enable or disable the Slideshow mode in the Inline Preview', 'wpcloudplugins'); ?></div>
              <div class="useyourdrive-option-title"><?php esc_html_e('Delay between cycles (ms)', 'wpcloudplugins'); ?></div>
              <div class="useyourdrive-option-description"><?php esc_html_e('Delay between cycles in milliseconds, the default is 5000', 'wpcloudplugins'); ?>.</div>
        ...
        <div id="settings_sorting" class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-tab-panel-header"><?php esc_html_e('Sorting', 'wpcloudplugins'); ?></div>

          <div class="useyourdrive-option-title"><?php esc_html_e('Sort field', 'wpcloudplugins'); ?></div>
          <?php
          ...
          <div class="useyourdrive-option-radio">
            ...
            <label for="name" class="useyourdrive-option-radio-label"><?php esc_html_e('Name', 'wpcloudplugins'); ?></label>
          </div>
          <div class="useyourdrive-option-radio">
            <input type="radio" id="size" name="sort_field" <?php echo ('size' === $sortfield) ? 'checked="checked"' : ''; ?> value="size" />
            <label for="size" class="useyourdrive-option-radio-label"><?php esc_html_e('Size', 'wpcloudplugins'); ?></label>
          </div>
          <div class="useyourdrive-option-radio">
            <input type="radio" id="created" name="sort_field" <?php echo ('created' === $sortfield) ? 'checked="checked"' : ''; ?> value="created" />
            <label for="created" class="useyourdrive-option-radio-label"><?php esc_html_e('Date of creation', 'wpcloudplugins'); ?></label>
          </div>
          <div class="useyourdrive-option-radio">
            <input type="radio" id="modified" name="sort_field" <?php echo ('modified' === $sortfield) ? 'checked="checked"' : ''; ?> value="modified" />
            <label for="modified" class="useyourdrive-option-radio-label"><?php esc_html_e('Last modified date', 'wpcloudplugins'); ?></label>
          </div>
          <div class="useyourdrive-option-radio">
            <input type="radio" id="shuffle" name="sort_field" <?php echo ('shuffle' === $sortfield) ? 'checked="checked"' : ''; ?> value="shuffle" />
            <label for="shuffle" class="useyourdrive-option-radio-label"><?php esc_html_e('Shuffle/Random', 'wpcloudplugins'); ?></label>
          </div>

          <div class="option-sort-field">
            <div class="useyourdrive-option-title"><?php esc_html_e('Sort order:', 'wpcloudplugins'); ?></div>
            ...
            <div class="useyourdrive-option-radio">
              ...
              <label for="asc" class="useyourdrive-option-radio-label"><?php esc_html_e('Ascending', 'wpcloudplugins'); ?></label>
            </div>
            <div class="useyourdrive-option-radio">
              <input type="radio" id="desc" name="sort_order" <?php echo ('desc' === $sortorder) ? 'checked="checked"' : ''; ?> value="desc" />
              <label for="desc" class="useyourdrive-option-radio-label"><?php esc_html_e('Descending', 'wpcloudplugins'); ?></label>
            </div>
          </div>
        </div>
        <!-- End Sorting Tab -->
        ...
        <div id="settings_advanced" class="useyourdrive-tab-panel">
          ...
          <div class=" forfilebrowser forsearch forgallery">
            <div class="useyourdrive-option-title"><?php esc_html_e('Allow Preview', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
                <?php
                $allow_preview = true;
                if (isset($_REQUEST['allowpreview']) && '0' === $_REQUEST['allowpreview']) {
                    $allow_preview = false;
                }
                if (isset($_REQUEST['forcedownload']) && '1' === $_REQUEST['forcedownload']) {
                    $allow_preview = false;
                }
                ?>
                <input type="checkbox" name="UseyourDrive_allow_preview" id="UseyourDrive_allow_preview" class="useyourdrive-onoffswitch-checkbox" <?php echo ($allow_preview) ? 'checked="checked"' : ''; ?> data-div-toggle="preview-options" />
                <label class="useyourdrive-onoffswitch-label" for="UseyourDrive_allow_preview"></label>
              </div>
            </div>


            <div class="useyourdrive-suboptions preview-options <?php echo ($allow_preview) ? '' : 'hidden'; ?>">
              <div class="useyourdrive-option-title"><?php esc_html_e('Inline Preview', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
              ...
              <div class="useyourdrive-option-description"><?php esc_html_e('Open preview inside a lightbox or open in a new window', 'wpcloudplugins'); ?></div>
              ...
              <div class="useyourdrive-suboptions preview-options-inline <?php echo (isset($_REQUEST['previewinline']) && '0' === $_REQUEST['previewinline']) ? 'hidden' : ''; ?>">
                ...
                <div class="useyourdrive-option-title"><?php esc_html_e('Enable Google pop out Button', 'wpcloudplugins'); ?>
                  <div class="useyourdrive-onoffswitch">
                ...
                <div class="useyourdrive-option-description"><?php esc_html_e('Activate the Google Pop Out button which is visible in the inline preview for a couple of file formats', 'wpcloudplugins'); ?>. </div>

                <div class="useyourdrive-option-title">Lightbox <?php esc_html_e('Navigation', 'wpcloudplugins'); ?>
                  <div class="useyourdrive-onoffswitch">
                ...
                <div class="useyourdrive-option-description"><?php esc_html_e('Navigate through your documents in the inline preview. Disable when each document should be shown individually without navigation arrows', 'wpcloudplugins'); ?>. </div>
          ...
          <div class="option forfilebrowser foruploadbox forgallery forsearch">
            <div class="useyourdrive-option-title"><?php esc_html_e('Allow Searching', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-option-description"><?php esc_html_e('The search function allows your users to find files by filename and content (when files are indexed)', 'wpcloudplugins'); ?></div>


            <div class="useyourdrive-suboptions option search-options <?php echo (isset($_REQUEST['search']) && '1' === $_REQUEST['search']) ? '' : 'hidden'; ?>">
              <div class="useyourdrive-option-title"><?php esc_html_e('Perform Full-Text search', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
              ...
              <div class="useyourdrive-option-title"><?php esc_html_e('Initial Search Term', 'wpcloudplugins'); ?></div>
              <div class="useyourdrive-option-description"><?php esc_html_e('Add search terms if you want to start a search when the shortcode is rendered. Please note that this only affects the initial render. If you want to only show specific files, you can use the Exclusions tab', 'wpcloudplugins'); ?>.</div>
          ...
          <div class=" forfilebrowser forsearch forgallery">
            ...
            if (version_compare(phpversion(), '7.1.0', '>')) {
                ?>
              <div class="useyourdrive-option-title"><?php esc_html_e('Allow ZIP Download', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
              ...
              <div class="useyourdrive-option-description"><?php esc_html_e('Allow users to download multiple files at once', 'wpcloudplugins'); ?></div>
            <?php
            } ?>
          </div>

          <div class="foraudio forvideo">
            <div class="useyourdrive-option-title"><?php esc_html_e('Auto Play', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
              ...
              <div class="useyourdrive-option-description"><?php esc_html_e('Autoplay is generally not recommended as it is seen as a negative user experience. It is also disabled in many browsers', 'wpcloudplugins'); ?>.</div>
            </div>
          </div>

          <div class="forvideo">
            <div class="useyourdrive-option-title"><?php esc_html_e('Enable Video Advertisements', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
        ...
        <div id="settings_exclusions" class="useyourdrive-tab-panel">
          <div class="useyourdrive-tab-panel-header"><?php esc_html_e('Exclusions', 'wpcloudplugins'); ?></div>

          <div class="showfiles-options">
            <div class="useyourdrive-option-title"><?php esc_html_e('Number of files to show', 'wpcloudplugins'); ?>
            </div>
            <div class="useyourdrive-option-description"><?php esc_html_e('Can be used for instance to only show the last 5 updated documents', 'wpcloudplugins'); ?>. <?php esc_html_e('Leave this field empty or set it to -1 for no limit', 'wpcloudplugins'); ?></div>
          ...
          <div class="useyourdrive-option-title"><?php esc_html_e('Only show files with those extensions', 'wpcloudplugins'); ?>:</div>
          <div class="useyourdrive-option-description"><?php echo esc_html__('Add extensions separated with | e.g. (jpg|png|gif)', 'wpcloudplugins').'. '.esc_html__('Leave empty to show all files', 'wpcloudplugins'); ?>.</div>
          ...
          <div class="useyourdrive-option-title"><?php esc_html_e('Only show the following files or folders', 'wpcloudplugins'); ?>:</div>
          <div class="useyourdrive-option-description"><?php echo esc_html__('Add files or folders by name or ID separated with | e.g. (file1.jpg|long folder name)', 'wpcloudplugins'); ?>. <?php echo esc_html__('Wildcards like * and ? are allowed', 'wpcloudplugins'); ?>.</div>
          ...
          <div class="useyourdrive-option-title"><?php esc_html_e('Hide files with those extensions', 'wpcloudplugins'); ?>:</div>
          <div class="useyourdrive-option-description"><?php echo esc_html__('Add extensions separated with | e.g. (jpg|png|gif)', 'wpcloudplugins').'. '.esc_html__('Leave empty to show all files', 'wpcloudplugins'); ?>.</div>
          ...
          <div class="useyourdrive-option-title"><?php esc_html_e('Hide the following files or folders', 'wpcloudplugins'); ?>:</div>
          <div class="useyourdrive-option-description"><?php echo esc_html__('Add files or folders by name or ID separated with | e.g. (file1.jpg|long folder name)', 'wpcloudplugins'); ?>. <?php echo esc_html__('Wildcards like * and ? are allowed', 'wpcloudplugins'); ?>.</div>
        ...
        <div id="settings_upload" class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-tab-panel-header"><?php esc_html_e('Upload Box', 'wpcloudplugins'); ?></div>

          <div class="useyourdrive-option-title"><?php esc_html_e('Allow Upload', 'wpcloudplugins'); ?>
            <div class="useyourdrive-onoffswitch">
          ...
          <div class="option upload-options <?php echo (isset($_REQUEST['upload']) && '1' === $_REQUEST['upload'] && in_array($mode, ['files', 'upload', 'gallery'])) ? '' : 'hidden'; ?>">
            ...
            <div class="useyourdrive-option-title"><?php esc_html_e('Allow folder upload', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-option-description"><?php esc_html_e('Adds an Add Folder button to the upload form if the browser supports it', 'wpcloudplugins'); ?>. </div>


            <div class="useyourdrive-option-title"><?php esc_html_e('Automatically starting upload', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-option-description"><?php esc_html_e('Start the upload directly once it is selected on the users device', 'wpcloudplugins'); ?>. </div>

            <div class="useyourdrive-option-title"><?php esc_html_e('Overwrite existing files', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-option-description"><?php esc_html_e('Overwrite already existing files or auto-rename the new uploaded files', 'wpcloudplugins'); ?>. </div>

            <div class="useyourdrive-option-title"><?php esc_html_e('Keep last modified date', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
                <input type="checkbox" name="UseyourDrive_upload_keep_filedate" id="UseyourDrive_upload_keep_filedate" class="useyourdrive-onoffswitch-checkbox" <?php echo (isset($_REQUEST['upload_keep_filedate']) && '1' === $_REQUEST['upload_keep_filedate']) ? 'checked="checked"' : ''; ?> />
                <label class="useyourdrive-onoffswitch-label" for="UseyourDrive_upload_keep_filedate"></label>
              </div>
            </div>
            <div class="useyourdrive-option-description"><?php esc_html_e('By default, the last modified date will be changed to the date/time when the file was uploaded. If you want to keep the original date, enable this setting', 'wpcloudplugins'); ?>. </div>


            <div class="useyourdrive-option-title"><?php esc_html_e('Restrict file extensions', 'wpcloudplugins'); ?></div>
            <div class="useyourdrive-option-description"><?php echo esc_html__('Add extensions separated with | e.g. (jpg|png|gif)', 'wpcloudplugins').' '.esc_html__('Leave empty for no restriction', 'useyourdrive', 'wpcloudplugins'); ?>.</div>
            ...
            <div class="useyourdrive-option-title"><?php esc_html_e('Max uploads per session', 'wpcloudplugins'); ?></div>
            <div class="useyourdrive-option-description"><?php echo esc_html__('Number of maximum uploads per upload session', 'wpcloudplugins').' '.esc_html__('Leave empty for no restriction', 'wpcloudplugins'); ?>.</div>
            ...
            <div class="useyourdrive-option-title"><?php esc_html_e('Minimum file size', 'wpcloudplugins'); ?></div>
            <?php
            ...
            <div class="useyourdrive-option-description"><?php esc_html_e('Min filesize (e.g. 1 MB) for uploading', 'wpcloudplugins'); ?>. <?php echo esc_html__('Leave empty for no restriction', 'wpcloudplugins'); ?>.</div>
            <input type="text" name="UseyourDrive_minfilesize" id="UseyourDrive_minfilesize" value="<?php echo $min_size_value; ?>" />

            <div class="useyourdrive-option-title"><?php esc_html_e('Maximum file size', 'wpcloudplugins'); ?></div>
            <?php
            ...
            <div class="useyourdrive-option-description"><?php esc_html_e('Max filesize for uploading', 'wpcloudplugins'); ?>. <?php echo esc_html__('Leave empty for no restriction', 'wpcloudplugins'); ?>.</div>
            <input type="text" name="UseyourDrive_maxfilesize" id="UseyourDrive_maxfilesize" placeholder="<?php esc_html_e('No limit', 'wpcloudplugins'); ?>" value="<?php echo $max_size_value; ?>" />

            <div style="<?php echo ((version_compare(phpversion(), '7.1.0', '<='))) ? '' : 'display:none;'; ?>">
              <div class="useyourdrive-option-title"><?php esc_html_e('Encryption', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
              ...
              <div class="useyourdrive-option-description"><?php esc_html_e('Use the powerful 256-bit AES Crypt encryption to securely store your files in the cloud', 'wpcloudplugins'); ?>. <?php esc_html_e('The encryption takes place on your server before the files are uploaded', 'wpcloudplugins'); ?>. <?php esc_html_e('You can decrypt the files with a tool like:', 'wpcloudplugins'); ?> <a href="https://www.aescrypt.com/download/" target="_blank">AES Crypt</a>.</div>
              <div class="useyourdrive-suboptions upload-encryption-options <?php echo (isset($_REQUEST['upload_encryption']) && '1' === $_REQUEST['upload_encryption']) ? '' : 'hidden'; ?>">
                <div class="useyourdrive-option-title"><?php esc_html_e('Passphrase'); ?></div>
            ...
            <div class="useyourdrive-option-title"><?php esc_html_e('Convert to Google Docs when possible', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-suboptions upload-convert-options <?php echo (isset($_REQUEST['convert']) && '1' === $_REQUEST['convert']) ? '' : 'hidden'; ?>">
              <div class="useyourdrive-option-title"><?php esc_html_e('Convert following mimetypes', 'wpcloudplugins'); ?></div>
              <?php
              $importFormats = [
        ...
        <div id="settings_notifications" class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-option-title"><?php esc_html_e('Download email notification', 'wpcloudplugins'); ?>
            <div class="useyourdrive-onoffswitch">
          ...
          <div class="option upload-options">
            <div class="useyourdrive-option-title"><?php esc_html_e('Upload email notification', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
          ...
          <div class="option delete-options">
            <div class="useyourdrive-option-title"><?php esc_html_e('Delete email notification', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
          ...
          ?>
          <div class="useyourdrive-option-description"><?php echo esc_html__('On which email address would you like to receive the notification?', 'wpcloudplugins').' '.wp_kses(__('Add multiple email addresses by separating them with a comma (<code>,</code>)', 'wpcloudplugins'), ['code' => []]).'. '.sprintf(esc_html__('Available placeholders: %s', 'wpcloudplugins'), $placeholders); ?>.</div>
        ...
        <div id="settings_manipulation" class="useyourdrive-tab-panel">
          <div class="useyourdrive-tab-panel-header"><?php esc_html_e('File Manipulation', 'wpcloudplugins'); ?></div>

          <div class="option forfilebrowser forgallery forsearch">
            <div class="useyourdrive-option-title"><?php esc_html_e('Allow Direct Links', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-option-description"><?php esc_html_e('Allow users to generate a link to a folder/file on your website. Only users with access to the shortcode and content will be able to open the link', 'wpcloudplugins'); ?></div>

            <div class="useyourdrive-option-title"><?php esc_html_e('Allow Sharing', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-option-description"><?php esc_html_e('Allow users to generate permanent shared links to the files', 'wpcloudplugins'); ?></div>
          </div>
          <div class="option forfilebrowser forgallery forsearch foruploadbox">
            <div class="useyourdrive-option-title"><?php esc_html_e('Add/Edit descriptions', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
          ...
          <div class="option forfilebrowser forgallery forsearch">
            <div class="useyourdrive-option-title"><?php esc_html_e('Rename files and folders', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-option-title"><?php esc_html_e('Move files and folders', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-option-title"><?php esc_html_e('Copy files', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-option-title"><?php esc_html_e('Delete files and folders', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
            ...
            <div class="useyourdrive-suboptions delete-options <?php echo (isset($_REQUEST['delete']) && '1' === $_REQUEST['delete']) ? '' : 'hidden'; ?>">
              <div class="useyourdrive-option-title"><?php esc_html_e('Delete to trash', 'wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
          ...
          <div class="option forfilebrowser ">
            <div class="useyourdrive-option-title"><?php esc_html_e('Create new documents', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
          ...
          <div class="option forfilebrowser forgallery">
            <div class="useyourdrive-option-title"><?php esc_html_e('Create new folders', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
          ...
          <div class="option forfilebrowser">
            <div class="useyourdrive-option-title"><?php esc_html_e('Edit Google Docs and Office documents', 'wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
        ...
        <div id="settings_permissions" class="useyourdrive-tab-panel">
          <div class="useyourdrive-tab-panel-header"><?php esc_html_e('User Permissions', 'wpcloudplugins'); ?></div>
          ...
          <div class="useyourdrive-accordion">
            ...
            <div class="option forfilebrowser foruploadbox forgallery foraudio forvideo forsearch useyourdrive-permissions-box">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can see the module?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option forfilebrowser useyourdrive-permissions-box preview-options">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can preview?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
                $selected = (isset($_REQUEST['previewrole'])) ? explode('|', $_REQUEST['previewrole']) : ['all'];
                wp_roles_and_users_input('UseyourDrive_preview_role', $selected); ?>
              </div>
            </div>

            <div class="option forfilebrowser forgallery foraudio forvideo forsearch useyourdrive-permissions-box">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can download?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery foruploadbox upload-options">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can upload?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery forsearch deeplink-options ">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can link to content?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery forsearch sharing-options ">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can share content?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery forsearch edit-options ">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can edit content?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery foruploadbox forsearch editdescription-options ">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can add/edit descriptions?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery forsearch rename-options ">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can rename files?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery forsearch rename-options ">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can rename folders?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery forsearch move-options">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can move files?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery forsearch move-options">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can move folders?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery forsearch copy-options">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can copy files?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <!-- <div class="option useyourdrive-permissions-box forfilebrowser forgallery forsearch copy-options">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can copy folders?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery forsearch delete-options ">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can delete files?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery forsearch delete-options ">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can delete folders?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser createdocument-options ">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can create new documents?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery addfolder-options ">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php esc_html_e('Who can create new folders?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
