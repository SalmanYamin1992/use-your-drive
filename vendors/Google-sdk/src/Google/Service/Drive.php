...
class UYDGoogle_Service_Drive extends UYDGoogle_Service
{
    ...
    public function __construct(UYDGoogle_Client $client)
    {
        ...
        $this->drives = new UYDGoogle_Service_Drive_Drives_Resource(
            $this,
            $this->serviceName,
            'drives',
            [
...
class UYDGoogle_Service_Drive_About_Resource extends UYDGoogle_Service_Resource
{
    ...
    public function get($optParams = [])
    {
        ...
        return $this->call('get', [$params], 'UYDGoogle_Service_Drive_About');
    }
}
...
class UYDGoogle_Service_Drive_Changes_Resource extends UYDGoogle_Service_Resource
{
    ...
    public function getStartPageToken($optParams = [])
    {
        ...
        return $this->call('getStartPageToken', [$params], 'UYDGoogle_Service_Drive_StartPageToken');
    }
    ...
    public function listChanges($pageToken, $optParams = [])
    {
        ...
        return $this->call('list', [$params], 'UYDGoogle_Service_Drive_ChangeList');
    }
     ...
     */
    public function watch($pageToken, UYDGoogle_Service_Drive_Channel $postBody, $optParams = [])
    {
        $params = ['pageToken' => $pageToken, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('watch', [$params], 'UYDGoogle_Service_Drive_Channel');
    }
}
...
class UYDGoogle_Service_Drive_Channels_Resource extends UYDGoogle_Service_Resource
{
     ...
     * @param array             $optParams optional parameters
     */
    public function stop(UYDGoogle_Service_Drive_Channel $postBody, $optParams = [])
    {
...
class UYDGoogle_Service_Drive_Comments_Resource extends UYDGoogle_Service_Resource
{
     ...
     */
    public function create($fileId, UYDGoogle_Service_Drive_Comment $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('create', [$params], 'UYDGoogle_Service_Drive_Comment');
    }
    ...
    public function get($fileId, $commentId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], 'UYDGoogle_Service_Drive_Comment');
    }
    ...
    public function listComments($fileId, $optParams = [])
    {
        ...
        return $this->call('list', [$params], 'UYDGoogle_Service_Drive_CommentList');
    }
     ...
     * @return UYDGoogle_Service_Drive_Comment
     */
    public function update($fileId, $commentId, UYDGoogle_Service_Drive_Comment $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'commentId' => $commentId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], 'UYDGoogle_Service_Drive_Comment');
    }
}
...
class UYDGoogle_Service_Drive_Files_Resource extends UYDGoogle_Service_Resource
{
     ...
     *
     * @return UYDGoogle_Http_Request|UYDGoogle_Service_Drive_DriveFile
     */
    public function copy($fileId, UYDGoogle_Service_Drive_DriveFile $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('copy', [$params], 'UYDGoogle_Service_Drive_DriveFile');
    }
     ...
     * @return UYDGoogle_Http_Request|UYDGoogle_Service_Drive_DriveFile
     */
    public function create(UYDGoogle_Service_Drive_DriveFile $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('create', [$params], 'UYDGoogle_Service_Drive_DriveFile');
    }
    ...
    public function generateIds($optParams = [])
    {
        ...
        return $this->call('generateIds', [$params], 'UYDGoogle_Service_Drive_GeneratedIds');
    }
    ...
    public function get($fileId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], 'UYDGoogle_Service_Drive_DriveFile');
    }
     ...
     *
     * @return UYDGoogle_Http_Request|UYDGoogle_Service_Drive_FileList
     */
    public function listFiles($optParams = [])
    {
        ...
        return $this->call('list', [$params], 'UYDGoogle_Service_Drive_FileList');
    }
     ...
     * @return UYDGoogle_Http_Request|UYDGoogle_Service_Drive_DriveFile
     */
    public function update($fileId, UYDGoogle_Service_Drive_DriveFile $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], 'UYDGoogle_Service_Drive_DriveFile');
    }
     ...
     * @return UYDGoogle_Service_Drive_Channel
     */
    public function watch($fileId, UYDGoogle_Service_Drive_Channel $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);
...
class UYDGoogle_Service_Drive_Permissions_Resource extends UYDGoogle_Service_Resource
{
     ...
     */
    public function create($fileId, UYDGoogle_Service_Drive_Permission $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('create', [$params], 'UYDGoogle_Service_Drive_Permission');
    }
    ...
    public function get($fileId, $permissionId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], 'UYDGoogle_Service_Drive_Permission');
    }
    ...
    public function listPermissions($fileId, $optParams = [])
    {
        ...
        return $this->call('list', [$params], 'UYDGoogle_Service_Drive_PermissionList');
    }
     ...
     * @return UYDGoogle_Service_Drive_Permission
     */
    public function update($fileId, $permissionId, UYDGoogle_Service_Drive_Permission $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'permissionId' => $permissionId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], 'UYDGoogle_Service_Drive_Permission');
    }
}
...
class UYDGoogle_Service_Drive_Replies_Resource extends UYDGoogle_Service_Resource
{
     ...
     */
    public function create($fileId, $commentId, UYDGoogle_Service_Drive_Reply $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'commentId' => $commentId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('create', [$params], 'UYDGoogle_Service_Drive_Reply');
    }
    ...
    public function get($fileId, $commentId, $replyId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], 'UYDGoogle_Service_Drive_Reply');
    }
    ...
    public function listReplies($fileId, $commentId, $optParams = [])
    {
        ...
        return $this->call('list', [$params], 'UYDGoogle_Service_Drive_ReplyList');
    }
     ...
     * @return UYDGoogle_Service_Drive_Reply
     */
    public function update($fileId, $commentId, $replyId, UYDGoogle_Service_Drive_Reply $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'commentId' => $commentId, 'replyId' => $replyId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], 'UYDGoogle_Service_Drive_Reply');
    }
}
...
class UYDGoogle_Service_Drive_Revisions_Resource extends UYDGoogle_Service_Resource
{
    ...
    public function get($fileId, $revisionId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], 'UYDGoogle_Service_Drive_Revision');
    }
    ...
    public function listRevisions($fileId, $optParams = [])
    {
        ...
        return $this->call('list', [$params], 'UYDGoogle_Service_Drive_RevisionList');
    }
     ...
     * @return UYDGoogle_Service_Drive_Revision
     */
    public function update($fileId, $revisionId, UYDGoogle_Service_Drive_Revision $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'revisionId' => $revisionId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], 'UYDGoogle_Service_Drive_Revision');
    }
}

class UYDGoogle_Service_Drive_Drives_Resource extends UYDGoogle_Service_Resource
{
    /**
     * @param array $optParams
     *
     * @return UYDGoogle_Service_Drive_Drive
     */
    public function create(UYDGoogle_Service_Drive_Drive $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('create', [$params], 'UYDGoogle_Service_Drive_Drive');
    }
     ...
     * @param array  $optParams
     *
     * @return UYDGoogle_Service_Drive_DriveList
     */
    public function get($fileId, $optParams = [])
    {
        $params = ['driveId' => $fileId];
        ...
        return $this->call('get', [$params], 'UYDGoogle_Service_Drive_DriveList');
    }
    ...
    public function listDrives($optParams = [])
    {
        ...
        return $this->call('list', [$params], 'UYDGoogle_Service_Drive_DriveList');
    }
     ...
     * @return UYDGoogle_Service_Drive_DriveList
     */
    public function update($fileId, UYDGoogle_Service_Drive_Drive $postBody, $optParams = [])
    {
        $params = ['driveId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], 'UYDGoogle_Service_Drive_DriveList');
    }
}
...
class UYDGoogle_Service_Drive_Change extends UYDGoogle_Model
{
    ...
    public function setDrive(UYDGoogle_Service_Drive_Drive $drive)
    {
        $this->drive = $drive;
    }
...
class UYDGoogle_Service_Drive_DriveFile extends UYDGoogle_Collection
{
    ...
    protected $shortcutDetailsType = 'UYDGoogle_Service_Drive_DriveFileShortcutDetails';
    ...
    public function setShortcutDetails(UYDGoogle_Service_Drive_DriveFileShortcutDetails $shortcutDetails)
    {
...
class UYDGoogle_Service_Drive_DriveFileShortcutDetails extends UYDGoogle_Model
{
    public $targetId;
...
class UYDGoogle_Service_Drive_Drive extends UYDGoogle_Model
{
    ...
    public $name;
    public $themeId;
    protected $backgroundImageFileType = 'UYDGoogle_Service_Drive_DriveBackgroundImageFile';
    protected $backgroundImageFileDataType = '';
    protected $capabilitiesType = 'UYDGoogle_Service_Drive_DriveCapabilities';
    protected $capabilitiesDataType = '';

    /**
     * @param UYDGoogle_Service_Drive_DriveBackgroundImageFile
     */
    public function setBackgroundImageFile(UYDGoogle_Service_Drive_DriveBackgroundImageFile $backgroundImageFile)
    {
        $this->backgroundImageFile = $backgroundImageFile;
    }

    /**
     * @return UYDGoogle_Service_Drive_DriveBackgroundImageFile
     */
    ...
    /**
     * @param UYDGoogle_Service_Drive_DriveCapabilities
     */
    public function setCapabilities(UYDGoogle_Service_Drive_DriveCapabilities $capabilities)
    {
        $this->capabilities = $capabilities;
    }

    /**
     * @return UYDGoogle_Service_Drive_DriveCapabilities
     */
    public function getCapabilities()
    {
        return $this->capabilities;
...
class UYDGoogle_Service_Drive_DriveCapabilities extends UYDGoogle_Model
{
    public $canAddChildren;
...
class UYDGoogle_Service_Drive_DriveBackgroundImageFile extends UYDGoogle_Model
{
    public $id;
    public $width;
    public $xCoordinate;
...
class UYDGoogle_Service_Drive_DriveList extends UYDGoogle_Collection
{
    public $kind;
    public $nextPageToken;
    protected $collection_key = 'drives';
    protected $drivesType = 'UYDGoogle_Service_Drive_Drive';
    ...
    /**
     * @param UYDGoogle_Service_Drive_Drive[]
     * @param mixed $drives
     */
